  ...
  return (
    <main className="relative w-full min-h-screen bg-surface flex flex-col">
      ...
      <section className="relative w-full bg-surface text-navy-900 py-24 px-4 sm:px-8 flex flex-col items-center justify-center border-t border-navy-100">
        <h2 className="text-3xl sm:text-4xl font-light tracking-tight mb-8 text-center">Get in Touch</h2>
        <div className="max-w-4xl mx-auto flex flex-col gap-8 text-navy-700 font-light leading-relaxed">
          <p className="text-center">
            Our team is available 24/7 to assist B2G partners and citizens alike. 
            Contact information and forms will be updated here shortly.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-navy-50">
              <h3 className="text-xl font-medium text-navy-900 mb-3">Sales & Partnerships</h3>
              <p>Dummy content block for scrolling. Connect with our B2G implementation team.</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-navy-50">
              <h3 className="text-xl font-medium text-navy-900 mb-3">Technical Support</h3>
              <p>Dummy content block for scrolling. Reach out for API assistance or OpenAPI questions.</p>
            </div>
          </div>
