  ...
  return (
    <main className="relative w-full min-h-screen bg-surface flex flex-col">
      <div className="relative w-full h-screen overflow-hidden flex flex-col justify-between">
        <BoomerangVideoBg src="https://d8j0ntlcm91z4.cloudfront.net/user_38xzZboKViGWJOttwIXH07lWA1P/hf_20260307_083826_e938b29f-a43a-41ec-a153-3d4730578ab8.mp4" />
        ...
        <div className="relative z-20 flex-1 flex flex-col items-center text-center justify-center px-4 sm:px-6 max-w-7xl mx-auto w-full pb-24 sm:pb-32">
          ...
          <p className="mt-5 sm:mt-6 max-w-xl text-sm sm:text-base md:text-lg leading-relaxed text-white/90 font-light animate-fade-up delay-3 select-none drop-shadow-md">
            Everything you need to integrate your city systems with our eco-tech platform.
          </p>
      ...
      <section className="relative w-full bg-surface text-navy-900 py-24 px-4 sm:px-8 flex flex-col items-center justify-center border-t border-navy-100">
        <h2 className="text-3xl sm:text-4xl font-light tracking-tight mb-8 text-center">API References</h2>
        <div className="max-w-4xl mx-auto flex flex-col gap-8 text-navy-700 font-light leading-relaxed">
          <p className="text-center">
            Comprehensive guides, authentication protocols, and endpoint specifications for local government integration.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-navy-50">
              <h3 className="text-xl font-medium text-navy-900 mb-3">Authentication</h3>
              <p>Dummy content block for scrolling. We will detail the JWT flows and role-based access control here.</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-navy-50">
              <h3 className="text-xl font-medium text-navy-900 mb-3">Endpoints</h3>
              <p>Dummy content block for scrolling. We will detail the spatial query endpoints and B2G ingestion here.</p>
            </div>
          </div>
