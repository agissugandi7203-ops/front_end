      ...
      {isLoginOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 select-none">
          ...
          <div className="relative w-full max-w-[420px] z-10 animate-fade-up">
            {/* Shadow glow base */}
            <div className="absolute -inset-1 bg-gradient-to-r from-slate-200 to-slate-300/40 rounded-[32px] blur-lg opacity-40 pointer-events-none" />

            <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-2xl relative overflow-hidden">
              ...
              <button 
                onClick={() => setIsLoginOpen(false)}
                className="absolute top-4 right-4 p-2 rounded-xl border border-slate-100 hover:bg-slate-50 text-slate-400 hover:text-slate-700 transition-colors cursor-pointer"
                title="Close"
              >
              ...
              <div className="flex flex-col items-center text-center mb-6 select-none mt-2">
                <div className="h-14 w-14 rounded-2xl bg-slate-50 flex items-center justify-center border border-slate-100 shadow-sm mb-3.5">
              ...
              {/* Alert Error Box */}
              {loginError && (
                <div className="mb-5 flex items-start gap-2 p-3 rounded-xl bg-red-50 border border-red-100 text-red-700 text-xs animate-fade-up font-medium">
              ...
              {/* Mode Switcher */}
              <div className="flex p-1 bg-slate-50 border border-slate-100 rounded-xl mb-5">
                <button
                  type="button"
                  onClick={() => {
                    setLoginMode("live");
              ...
              <form onSubmit={handleLoginSubmit} className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-[10px] font-bold uppercase tracking-wider text-slate-650 pl-1 select-none">
                    Email
                  </label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-slate-50 border border-slate-100 rounded-xl py-2 pl-9 pr-4 text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:border-slate-350 focus:bg-white transition-all duration-150"
                      required
                    />
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="••••••••"
                      className="w-full bg-slate-50 border border-slate-100 rounded-xl py-2 pl-9 pr-9 text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:border-slate-350 focus:bg-white transition-all duration-150"
                      required
                    />
                    <button
                      type="button"
                      onClick={() => setShowPassword(!showPassword)}
                      className="absolute inset-y-0 right-0 pr-3 flex items-center text-slate-455 hover:text-slate-900 transition-colors cursor-pointer"
                    >
                ...
                <button
                  ...
                  className={`mt-3 w-full rounded-xl py-2.5 text-xs font-semibold transition-all duration-200 cursor-pointer disabled:opacity-50 flex items-center justify-center gap-2 select-none text-white ${
                    loginMode === "live" 
