  ...
  return (
    <main className="relative w-full min-h-screen bg-surface flex flex-col">
      <div className="relative w-full h-screen overflow-hidden flex flex-col justify-between">
        <BoomerangVideoBg src="https://d8j0ntlcm91z4.cloudfront.net/user_38xzZboKViGWJOttwIXH07lWA1P/hf_20260422_191657_800d4e1f-7ab3-41af-90b6-9bd3039eb294.mp4" />
      ...
      <section className="relative w-full bg-surface text-navy-900 py-24 px-4 sm:px-8 flex flex-col items-center justify-center border-t border-navy-100">
        <h2 className="text-3xl sm:text-4xl font-light tracking-tight mb-8 text-center">Core Platform Features</h2>
        <div className="max-w-4xl mx-auto flex flex-col gap-8 text-navy-700 font-light leading-relaxed">
          <p className="text-center">
            Deep dive into the architecture powering real-time ecological reports and citizen gamification.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-navy-50">
              <h3 className="text-xl font-medium text-navy-900 mb-3">Gamification Engine</h3>
              <p>Dummy content block for scrolling. Showcasing the badge unlocking system and daily streaks.</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-navy-50">
              <h3 className="text-xl font-medium text-navy-900 mb-3">Live Map Feeds</h3>
              <p>Dummy content block for scrolling. Showcasing the interactive mapping capabilities.</p>
            </div>
          </div>
